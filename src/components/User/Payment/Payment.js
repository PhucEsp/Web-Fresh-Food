...
function Payment() {
    ...
    const checkQuantityCheckout = (listCartRender) => {
        let check = true
    ...
    const handleSubmit = async () => {
        if(checkQuantityCheckout(listCartRender)){
            if(totalPrice() == 0){
                return;
            }
            const data = {
    ...
    console.log(`checkQuantityCheckout`, checkQuantityCheckout(listCartRender))
    ...
    return (
                        ...
                        <div class="content">
                            ...
                            >
                                ...
                                <TextField
                                    ...
                                    value={address}
                                />
                                <FormLabel className="title-box" component="legend">Chọn Phương Thức Thanh Toán</FormLabel>
                                    <RadioGroup aria-label="gender" name="offline" value={value} onChange={handleChange}>
                                        <FormControlLabel value="offline" control={<Radio />} label="Thanh toán khi nhận hàng" />
                                        <FormControlLabel value="online" control={<Radio />} label="Thanh toán Online (Paypal)" />
                                    </RadioGroup>
                                <div>
        ...
        >
            ...
            <Alert severity="error">
                <AlertTitle><h4>Rất tiếc</h4></AlertTitle>
                <h5>Một trong những sản phẩm trong đơn hàng của bạn vừa hết hàng.<strong>Vui lòng quay lại giỏ hàng để kiểm tra!</strong></h5>
            </Alert>
            <div className={classes.buttonModal}>
                <Button onClick={handleBackToCart} variant="outlined">Quay lại</Button>
            </div>
